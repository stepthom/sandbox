...
Kiva's data science team has been tasked to determine if this unfortunate default--- and other like it--- could have been predicted based on the data in the loan application? The data science team is especially curious if the personal story adds predictive value. Since the story is textual, not numerical, Kiva's data science team nees to use text analytics. Text analytics provides a suite of techniques to understand and organize text data, such as the personal stories on Kiva's loan applications. Can Kiva's data science team therefore use Text Analytics to leverage the personal stories to build a prediction system for loan applications, thereby reducing risk for lenders and Kiva?
