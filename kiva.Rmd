...
In this case study, we will build a prediction model (in particular, a decision tree classifier) to predict who will pay back loans, and who will default. A key question we explore is: does adding text (i.e., the personal stories) to the prediction model increase or decrease its prediction power?
...
- Which words are most biased towards defaulting? Is this expected/intuitive?
- According to the decision tree models, what variables predict a default?
- As a decision maker, would you recommend the use of textual data in your prediction models?
